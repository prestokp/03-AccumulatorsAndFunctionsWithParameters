...
def run_test_sum_of_digits():
    ...
    # Test 3:
    expected = 12
    answer = sum_of_digits(2235)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    #Test 4:
    expected = 39
    answer = sum_of_digits(17386950)
...
def run_test_digits_in_cube():
    ...
    print('Test 2 expected:', expected)
    print('Test 2 answer:', answer)

    #Test 3:
    expected = 1
    answer = digits_in_cube(1)
    print('Test 3 expected:', expected)
    print('Test 3 answer:', answer)
...
def run_test_digits_in_power():
    ...
    #Test 1
    expected = 58
    answer = digits_in_power(4,16)
    print('Test 1 Expected:', expected)
    print('Test 1 Answer:', answer)

    #Test 2
    expected = 67
    answer = digits_in_power(52,8)
    print('Test 2 Expected:', expected)
    print('Test 2 Answer:', answer)
