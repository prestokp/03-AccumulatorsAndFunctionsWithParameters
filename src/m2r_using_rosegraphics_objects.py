...
#              rg.Point(0,0)  0,0 is the origin on a coordinate system
#
#        -- In what direction on the screen
#           does the positive X-axis point?
#              Positive X-axis moves right at all points on the second window
#
#        -- In what direction on the screen
#           does the positive Y-axis point?
#              Positive Y-axis moves down at all points on the second window
#
#     b. Write a line of code that constructs a RoseWindow object:
#            point3 = rg.Point(300,300)
#
#            tesla = rg.SimpleTurtle('turtle')
#
...
#                rg.Rectangle(rg.Point(x,y),rg.Point(x1,y2))
#
#
...
#        necessary?  Why?
#            It's necessary after the code has executed the objects in a window so you can close the window to finish the execution or to progress to the next window
#
